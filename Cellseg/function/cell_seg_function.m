...
imageout=mydeepseg_cic_no_norm(aaa,'AI_cell_new.mat',1,50,BW233,1);
...
image_brownweak=imageout==3;
image_brownstrong=imageout==2;
image_brown = bwareaopen((image_brownweak+image_brownstrong+BWbrown)>0,100);


image_blue=imageout==4;
