...
close all
addpath recentbk
PathNameRGBmain= 'D:\image_folder\annoatation\processimage\';
PathNameRGBori= 'D:\image_folder\nick2\images\';
PathNameRGB= 'D:\image_folder\annoatation\mask\';
...
for ii=1:nfiles
    ...
    for iibox=1:sizestate(1)
        ...
        imagedata=imresize(imagedata,0.5,'nearest');
        datamaskeos_small=imresize(datamaskeos_small,0.5,'nearest');
        ...
        for xxi=1:600:xxxxxsize
            for yyi=1:600:yyyysize
                try
